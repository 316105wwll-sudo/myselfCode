...
为高激励任务（例如，空投或前沿活动）提供的可选11个锁定机制。
...
- **原因：** 此决定是我们持续产品精简的一部分，旨在将资源和用户注意力集中在我们最高优先级的活跃前沿。机器人前沿已完成其计划的探索阶段，其退役使我们能够整合努力。
- **注意：** 用户在机器人前沿的过去贡献和奖励将被保留，并可在其贡献历史中查看。没有其他前沿或平台功能受到影响。
...
- **原因：** 此决定是我们持续产品精简的一部分，旨在将资源和用户注意力集中在我们最高优先级的活跃前沿。加密前沿已完成其计划的探索阶段，其退役使我们能够整合努力。
- **注意：** 用户在加密前沿的过去贡献和奖励将被保留，并可在其贡献历史中查看。没有其他前沿或平台功能受到影响。
...
通过高奖励机制和反垃圾邮件执行系统，系统性地收集高质量、结构化数据，确保有效性和学术价值，并奖励长期贡献者，丰富平台的数据生态系统，推出五个新前沿模块。

- **行动：** 启动空投第一季，奖池为250万$XNY和积分奖励。
- **新前沿：**
  - **模型比较：** 比较不同AI模型的性能指标和业务结果，以识别最佳或混合解决方案。
...
- **如何：** 选定的前沿任务提供额外的$XNY或USDT奖励，与基础积分无关。活动参数（奖励金额、持续时间、目标）按前沿设置，并显示在各自的主页上。
...
- **访问：** 通过Binance钱包助推器标签或主页横幅访问（需要Alpha积分≥61）。
...
- **Access:** 通过 Binance Wallet Booster 标签或主页横幅访问（需要 Alpha Points ≥ 61）。
- **Rewards:** 总奖励池为 50,000,000 $XNY（有锁定期），在任务完成和验证后分配。
- **Timeline:** 2025年8月15日 07:00 UTC – 2025年8月22日 07:00 UTC。
...
- **Access:** 通过 Binance Wallet Booster 标签或主页横幅访问（Alpha Points ≥ 61）。
- **Rewards:** 总奖励池为 50,000,000 $XNY（有锁定期），在任务完成和验证后分配。
- **Timeline:** 2025年8月8日 07:00 UTC – 2025年8月15日 07:00 UTC。
...
在三个核心领域收集注释数据：AI 食品模型比较、机器人交互注释和 CEX 热钱包数据标注。

- **Access:** 通过 Binance Wallet Booster 标签或主页横幅访问（Alpha Points ≥ 61）。
- **Rewards:** 总奖励池为 50,000,000 $XNY（有锁定期），在任务完成和验证后分配。
- **Timeline:** 2025年8月1日 07:00 UTC – 2025年8月8日 07:00 UTC。
...
通过注释的真实世界交互数据验证 AI 食品分析并增强机器人训练。

- **Access:** 通过 Binance Wallet Booster 标签或主页横幅访问（Alpha Points ≥ 61）。
- **Rewards:** 总奖励池为 50,000,000 $XNY（有锁定期），在任务完成和验证后分配。
- **Timeline:** 2025年7月24日 07:00 UTC – 2025年7月31日 07:00 UTC。
...
通过收集丰富的注释，深化 AI 对食品的理解，超越标签，包括重量、烹饪方法和热量内容。

- **Access:** 通过 Binance Wallet Booster 标签或主页横幅访问（Alpha Points ≥ 61）。
- **Rewards:** 总奖励池为 50,000,000 $XNY，在任务完成和验证后分配。
- **Timeline:** 2025年7月16日 13:00 UTC – 2025年7月23日 13:00 UTC。
...
通过收集即食食品的注释图像，教会 AI 对人类饮食习惯的细致理解，关注文化和上下文的相关性，超越简单标签。

- **Access:** 通过 Binance Wallet Booster 标签或主页横幅访问（Alpha Points ≥ 61）。
- **Rewards:** 总奖励池为 50,000,000 $XNY，在任务完成和验证后分配。
- **Timeline:** 2025年7月9日 13:00 UTC – 2025年7月16日 13:00 UTC。
...
- **How:** 于 2025年6月30日 暂时下线，现在已全面恢复。
- **Why:** 通过架构升级增强系统稳定性和用户体验。
...
- **Access:** 通过 Binance Wallet Booster 标签或主页横幅访问（Alpha Points ≥ 61）。
- **Rewards:** 总奖励池为 50,000,000 $XNY，在任务完成和验证后分配。
- **Timeline:** 2025年7月2日 13:00 UTC – 2025年7月9日 13:00 UTC。
...
通过收集注释食品数据、通过测验参与社区知识，并通过多层次激励结构奖励参与，启动首季。

- **Access:** 通过 Binance Wallet Booster 标签或主页横幅访问（Alpha Points ≥ 61）。
- **Rewards:** 总奖励池为 50,000,000 $XNY，在任务完成和验证后分配。
- **Timeline:** 2025年6月25日 13:00 UTC – 2025年7月2日 13:00 UTC。
