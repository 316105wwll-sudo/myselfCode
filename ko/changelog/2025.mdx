...
암호화폐 프론티어 QUEST 모듈과 모든 관련 작업(제출, 검증 및 보물 사냥 포함)이 오프라인 상태가 되었습니다.
...
고보상 메커니즘과 스팸 방지 강화를 통해 고품질의 구조화된 데이터를 체계적으로 수집하여 유효성과 학문적 가치를 보장하고, 장기 기여자에게 보상을 제공하며 플랫폼의 데이터 생태계를 다각화하기 위해 다섯 개의 새로운 프론티어 모듈을 도입합니다.

- **행동:** 250만 $XNY 상금 풀과 포인트 보상이 포함된 에어드랍 시즌 1을 시작했습니다.
- **새로운 프론티어:**
...
- **이유:** 목표 인센티브를 통해 고부가가치 데이터 작업에 대한 참여를 촉진하고 데이터 품질과 생태계 참여를 개선하기 위해서입니다.
...
AI의 음식 이해도를 심화하기 위해 레이블을 넘어 무게, 조리 방법 및 칼로리 함량을 포함한 풍부한 주석을 수집합니다.
...
- **방법:** 2025년 6월 30일에 일시적으로 오프라인 상태였으며, 현재는 종합적으로 복원되었습니다.
...
채식, 비채식 및 혼합 카테고리 전반에 걸쳐 미묘한 이미지 레이블링을 통해 AI의 글로벌 음식 문화 및 선호도를 확장합니다.
...
주석이 달린 음식 데이터를 수집하고, 퀴즈를 통해 커뮤니티 지식을 활용하며, 다단계 인센티브 구조를 통해 참여를 보상하여 첫 시즌을 시작합니다.
