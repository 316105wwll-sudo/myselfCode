...
## 2025년 12월 08일
---
**인센티브 진화: 장기 생태계 관리를 위한 Lock-1업 유지**

<br />

<div style={{ marginTop: "1rem" }}></div>

고인센티브 작업(예: 에어드롭 또는 프론티어 캠페인)에서 보상을 위한 선택적 1221 aa 잠금 기능.

- **트리거:** 캠페인 후 보상이 귀하의 잔액에 입금됩니다.
- **잠금:** 자산 페이지를 통해 스마트 계약에 보상을 잠금으로써 안전하게 보호합니다.
- **해제:** 잠금 기간이 끝난 후, 한 번의 클릭으로 보상을 지갑으로 직접 청구합니다.
...
## 2025년 12월 05일
---
**인센티브 진화: 장기 생태계 관리를 위한 Re111111ward Lock-1업**

<br />

<div style={{ marginTop: "1rem" }}></div>

고인센티브 작업(예: 에어드롭 또는 프론티어 캠페인)에서 보상을 위한 선택적 11 aa 잠금 기능.
...
## 2025년 12월 04일
---
**인센티브 진화: 장기 생태계 관리를 위한 Reward 11 Lock-ups**

<br />

<div style={{ marginTop: "1rem" }}></div>

고인센티브 작업(예: 에어드롭 또는 프론티어 캠페인)에서 보상을 위한 선택적 잠금 기능.
...
물리학, 금융 및 다중 모드 분야에서 학술 수준의 데이터 세트를 체계적으로 수집하고, 세 개의 새로운 프론티어를 위한 고품질 데이터 파이프라인을 부트스트랩합니다.

- **행동:** 100만 달러의 $XNY 상금 풀로 에어드롭 시즌 2를 시작했습니다(3개월 선형 분배).
- **새로운 프론티어:**
  - **고급 물리학 질문:** 현재 AI가 정확하게 답변할 수 없는 고난이도 물리학 문제를 제출하기 위한 도메인 전문가.
...
탈중앙화 식별자(DID)에 계정을 바인딩할 수 있는 기본 업그레이드.

- **바인딩:** 다음 Codatta 로그인 시 온체인 DID의 셀프 서비스 통합.
- **연관:** 바인딩된 DID는 모든 작업 행동, 데이터 기여 및 보상 분배를 체계적으로 인덱싱하는 통합 기본 키 역할을 합니다.
- **계보:** 온체인 및 오프체인 활동의 완전한 추적 가능성과 검증을 가능하게 하여 불변의 데이터 출처를 설정합니다.

이 배포는 검증 가능한 데이터 경제를 위한 기술적 초석을 마련합니다. 각 기여자에게 지속적이고 고유한 디지털 정체성을 제공함으로써, 우리는 세분화된 기여 속성, 명확한 소유권 검증 및 프로토콜 수준에서의 투명한 인센티브 할당을 가능하게 합니다.
...
## 2025년 11월 03일
---
**퀘스트 시스템 조정: 암호화폐 프론티어 QUEST 모듈 사용 중지**

<br />

<div style={{ marginTop: "1rem" }}></div>

암호화폐 프론티어 QUEST 모듈과 모든 관련 작업(제출, 검증 및 보상 사냥 포함)이 오프라인 상태가 되었습니다.

- **이유:** 이 모듈은 현재 제품 로드맵에 따라 계획된 수명을 완료했습니다. 사용 중지는 시스템 간소화 및 향후 기능 출시를 위한 자원 재조정을 지원합니다.
- **참고:** 사용자의 과거 기여 기록과 이 모듈에서 얻은 보상은 그대로 유지됩니다. 이 변경으로 인해 다른 프론티어 모듈에는 영향을 미치지 않습니다.
...
## 2025년 10월 24일
---
**프론티어 시스템 조정: 로보틱스 프론티어 사용 중지**

<br />

<div style={{ marginTop: "1rem" }}></div>

로보틱스 프론티어가 공식적으로 사용 중지되었습니다. 이 조치는 프론트엔드 진입점에만 영향을 미칩니다. 모든 과거 기여 데이터는 그대로 유지되며 접근 가능합니다.

- **이유:** 이 결정은 자원과 사용자 주의를 가장 우선 순위가 높은 활성 프론티어에 집중하기 위한 지속적인 제품 간소화의 일환입니다. 로보틱스 프론티어는 계획된 탐색 단계를 완료하였으며, 사용 중지는 우리의 노력을 통합할 수 있게 합니다.
- **참고:** 사용자의 과거 기여 및 로보틱스 프론티어에서의 보상은 보존되며 기여 기록에서 검토할 수 있습니다. 다른 프론티어나 플랫폼 기능에는 영향을 미치지 않습니다.
...
## 2025년 10월 20일
---
**프론티어 시스템 조정: 암호화폐 프론티어 사용 중지**

<br />

<div style={{ marginTop: "1rem" }}></div>

암호화폐 프론티어가 공식적으로 사용 중지되었습니다. 이 조치는 프론트엔드 진입점에만 영향을 미칩니다. 모든 과거 기여 데이터는 그대로 유지되며 접근 가능합니다.

- **이유:** 이 결정은 자원과 사용자 주의를 가장 우선 순위가 높은 활성 프론티어에 집중하기 위한 지속적인 제품 간소화의 일환입니다. 암호화폐 프론티어는 계획된 탐색 단계를 완료하였으며, 사용 중지는 우리의 노력을 통합할 수 있게 합니다.
...
고품질의 구조화된 데이터를 체계적으로 수집하기 위해 높은 보상 메커니즘과 스팸 방지 조치를 통해 유효성과 학문적 가치를 보장하며, 장기 기여자에게 보상을 제공하고 플랫폼의 데이터 생태계를 다각화하기 위한 다섯 개의 새로운 프론티어 모듈을 도입합니다.

- **행동:** 250만 $XNY의 상금 풀과 포인트 보상이 포함된 에어드롭 시즌 1을 시작했습니다.
- **새로운 프론티어:**
  - **모델 비교:** 다양한 AI 모델 간의 성능 지표와 비즈니스 결과를 비교하여 최적의 솔루션 또는 하이브리드 솔루션을 식별합니다.
...
- **보상 구조:** 보상은 제출 평가에 따라 순위가 매겨지고 캠페인 후 배포됩니다. 악의적인 제출은 데이터 품질을 보장하기 위해 처벌됩니다.
...
프론티어를 위한 구성 가능한 보상 활동이 이제 제공되어 추가적인 고부가가치 인센티브를 제공합니다.

- **방법:** 선택된 프론티어 작업은 기본 포인트와 독립적으로 $XNY 또는 USDT로 추가 보상을 제공합니다. 활동 매개변수(보상 금액, 기간, 목표)는 각 프론티어별로 설정되며 해당 홈페이지에 표시됩니다.
...
- **접근:** 바이낸스 지갑 부스터 탭 또는 홈페이지 배너를 통해 접근 가능(Alpha 포인트 ≥ 61 필요).
- **보상:** 총 보상 풀 50,000,000 $XNY(잠금 기간 포함), 작업 완료 및 검증 후 배포됩니다.
...
AI 훈련 및 검증을 위해 생명, 로봇 공학, 암호화폐, 모델 비교 및 지문 검증에 대한 교차 도메인 데이터를 수집합니다.
...
AI 훈련 및 검증을 위해 생명, 로봇 공학 및 암호화폐에 대한 교차 도메인 데이터를 수집하고 주석을 달기 위해 진행합니다.
...
분산형 AI 훈련을 위해 생명, 로봇 공학 및 암호화폐에 대한 교차 도메인 주석 데이터의 기초를 마련합니다.
...
AI 식품 모델 비교, 로봇 상호작용 주석 및 CEX 핫 월렛 데이터 라벨링을 포함한 세 가지 핵심 도메인에서 주석이 달린 데이터를 수집합니다.
...
주석이 달린 실제 상호작용 데이터를 통해 AI 식품 분석을 검증하고 로봇 훈련을 향상시킵니다.
...
AI의 음식에 대한 이해를 심화하기 위해 레이블을 넘어 무게, 조리 방법 및 칼로리 함량을 포함한 풍부한 주석을 수집합니다.
...
AI가 인간의 식습관에 대한 미묘한 이해를 가질 수 있도록 준비된 음식의 주석이 달린 이미지를 수집하여 단순한 레이블을 넘어 문화적 및 맥락적 관련성에 중점을 둡니다.
...
- **방법:** 2025년 6월 30일에 일시적으로 오프라인 상태였으며, 현재 포괄적으로 복원되었습니다.
...
AI의 전 세계 음식 문화와 선호도를 이해하기 위해 채식, 비채식 및 혼합 카테고리 전반에 걸쳐 미묘한 이미지 레이블링을 확장합니다.
...
주석이 달린 음식 데이터를 수집하고, 퀴즈를 통해 커뮤니티 지식을 활용하며, 다단계 인센티브 구조를 통해 참여를 보상하여 첫 번째 시즌을 시작합니다.
...
export const ChangelogFilter = () => {
  ...
  const filterTypes = [
    ...
    { id: 'fixes', label: '버그 수정 및 기능 종료', color: '#EF4444', count: 3 },
