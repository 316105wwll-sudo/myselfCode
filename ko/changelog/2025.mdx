...
고인센티브 작업(예: 에어드랍 또는 프론티어 캠페인)에서 보상을 위한 선택적 1221 aa 잠금 기능.
...
물리학, 금융 및 다중 모달 분야에서 학술 수준의 데이터 세트를 체계적으로 수집하고, 세 가지 새로운 프론티어를 위한 고품질 데이터 파이프라인을 부트스트랩합니다.
...
전체 암호화폐 프론티어 QUEST 모듈 및 모든 관련 작업(제출, 검증 및 보상 사냥 포함)이 오프라인 상태로 전환되었습니다.

- **이유:** 이 모듈은 현재 제품 로드맵에 따라 계획된 수명을 완료했습니다. 사용 중지는 시스템 간소화 및 향후 기능 출시를 위한 자원 재조정을 지원합니다.
- **참고:** 사용자의 이력 기여 기록 및 이 모듈에서 획득한 보상은 그대로 유지됩니다. 이 변경으로 인해 다른 프론티어 모듈은 영향을 받지 않습니다.
...
- **이유:** 이 결정은 자원을 집중하고 사용자 주의를 가장 우선 순위가 높은 활성 프론티어에 집중하기 위한 지속적인 제품 간소화의 일환입니다. 로보틱스 프론티어는 계획된 탐색 단계를 완료하였으며, 이를 중단함으로써 노력을 통합할 수 있습니다.
...
- **이유:** 이 결정은 자원을 집중하고 사용자 주의를 가장 우선 순위가 높은 활성 프론티어에 집중하기 위한 지속적인 제품 간소화의 일환입니다. 암호화 프론티어는 계획된 탐색 단계를 완료하였으며, 이를 중단함으로써 노력을 통합할 수 있습니다.
...
높은 보상 메커니즘과 스팸 방지 강화를 통해 고품질의 구조화된 데이터를 체계적으로 수집하고, 유효성과 학문적 가치를 보장하며, 장기 기여자에게 보상하고 플랫폼의 데이터 생태계를 다각화하기 위해 다섯 개의 새로운 프론티어 모듈을 도입합니다.

- **조치:** 250만 $XNY의 상금 풀과 포인트 보상으로 에어드랍 시즌 1을 시작했습니다.
- **새로운 프론티어:**
...
- **접근성:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **보상:** 총 보상 풀 50,000,000 $XNY (잠금 기간 포함), 작업 완료 및 검증 후 분배.
- **일정:** August 15, 2025, 07:00 UTC – August 22, 2025, 07:00 UTC.
...
네 가지 주요 분야에서 주석이 달린 데이터를 체계적으로 수집하기 위해: 프로젝트 학습, 음식 AI 판단, 로봇 주석, CEX 데이터 확장.

- **접근성:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **보상:** 총 보상 풀 50,000,000 $XNY (잠금 기간 포함), 작업 완료 및 검증 후 분배.
- **일정:** August 8, 2025, 07:00 UTC – August 15, 2025, 07:00 UTC.
...
- **접근성:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **보상:** 총 보상 풀 50,000,000 $XNY (잠금 기간 포함), 작업 완료 및 검증 후 분배.
- **일정:** August 1, 2025, 07:00 UTC – August 8, 2025, 07:00 UTC.
...
AI 음식 분석을 검증하고 주석이 달린 실제 상호작용 데이터를 통해 로봇 교육을 향상시키기 위해.

- **접근성:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **보상:** 총 보상 풀 50,000,000 $XNY (잠금 기간 포함), 작업 완료 및 검증 후 분배.
- **일정:** July 24, 2025, 07:00 UTC – July 31, 2025, 07:00 UTC.
...
무게, 조리 방법, 칼로리 함량을 포함한 풍부한 주석을 수집하여 AI의 음식 이해를 심화시키기 위해.

- **접근성:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **보상:** 총 보상 풀 50,000,000 $XNY, 작업 완료 및 검증 후 분배.
- **일정:** July 16, 2025, 13:00 UTC – July 23, 2025, 13:00 UTC.
...
문화적 및 맥락적 관련성을 넘어 단순한 라벨을 초월하여 즉석 식품의 주석이 달린 이미지를 수집하여 AI에게 인간의 식습관에 대한 미묘한 이해를 가르치기 위해.

- **접근성:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **보상:** 총 보상 풀 50,000,000 $XNY, 작업 완료 및 검증 후 분배.
- **일정:** July 9, 2025, 13:00 UTC – July 16, 2025, 13:00 UTC.
...
- **접근성:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **보상:** 총 보상 풀 50,000,000 $XNY, 작업 완료 및 검증 후 분배.
- **일정:** July 2, 2025, 13:00 UTC – July 9, 2025, 13:00 UTC.
...
주석이 달린 음식 데이터를 수집하고, 퀴즈를 통해 커뮤니티 지식을 참여시키며, 다단계 인센티브 구조를 통해 참여를 보상하기 위해 첫 번째 시즌을 시작합니다.

- **접근성:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **보상:** 총 보상 풀 50,000,000 $XNY, 작업 완료 및 검증 후 분배.
- **일정:** June 25, 2025, 13:00 UTC – July 2, 2025, 13:00 UTC.
