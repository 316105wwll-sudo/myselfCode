...
## Dec 07, 2025
---
**진화하는 인센티브: 장기 생태계 관리를 위한 Lock-1업 유지**

<br />

<div style={{ marginTop: "1rem" }}></div>

고인센티브 작업(예: 에어드랍 또는 프론티어 캠페인)에서 보상을 위한 선택적 11 aa 잠금 기능.
...
## Dec 05, 2025
---
**진화하는 인센티브: 장기 생태계 관리를 위한 Re111111ward Lock-1업**
...
## Dec 04, 2025
---
**진화하는 인센티브: 장기 생태계 관리를 위한 Reward 11 Lock-ups**

<br />

<div style={{ marginTop: "1rem" }}></div>

고인센티브 작업(예: 에어드랍 또는 프론티어 캠페인)에서 보상을 위한 선택적 잠금 기능.
...
- **행동:** 1M $XNY 상금 풀로 에어드랍 시즌 2를 시작했습니다(3개월 선형 분배).
- **새로운 프론티어:**
  - **고급 물리학 질문:** 현재 AI가 정확하게 답변할 수 없는 고난이도 물리학 문제를 제출하기 위한 도메인 전문가.
  - **암호화폐 및 주식 정보:** 암호화폐 및 주식 투자 결정을 위한 신뢰할 수 있는 정보를 AI에 제공합니다.
...
이 배포는 검증 가능한 데이터 경제를 위한 기술적 초석을 마련합니다. 각 기여자에게 지속적이고 고유한 디지털 정체성을 제공함으로써 세분화된 기여 속성, 명확한 소유권 검증 및 프로토콜 수준에서의 투명한 인센티브 할당을 가능하게 합니다.
...
전체 암호화폐 프론티어 QUEST 모듈 및 모든 관련 작업(제출, 검증 및 보상 사냥 포함)이 오프라인 상태가 되었습니다.

- **이유:** 이 모듈은 현재 제품 로드맵에 따라 계획된 수명을 완료했습니다. 사용 중지는 시스템 간소화 및 향후 기능 출시를 위한 자원 재조정을 지원합니다.
- **참고:** 사용자의 이력 기여 기록 및 이 모듈에서 획득한 보상은 그대로 유지됩니다. 이 변경으로 인해 다른 프론티어 모듈에는 영향을 미치지 않습니다.
...
로보틱스 프론티어가 공식적으로 사용 중지되었습니다. 이 조치는 프론트엔드 진입점에만 영향을 미칩니다. 모든 이력 기여 데이터는 그대로 유지되며 접근 가능합니다.

- **이유:** 이 결정은 자원을 집중하고 사용자 주의를 가장 우선 순위가 높은 활성 프론티어에 맞추기 위한 지속적인 제품 간소화의 일환입니다. 로보틱스 프론티어는 계획된 탐색 단계를 완료하였으며, 이를 중단함으로써 노력을 통합할 수 있습니다.
- **참고:** 로보틱스 프론티어에서의 사용자 과거 기여 및 보상은 보존되며, 기여 내역에서 검토할 수 있습니다. 다른 프론티어나 플랫폼 기능에는 영향을 미치지 않습니다.
...
- **이유:** 시스템 자원을 보호하고, 모든 기여자의 공정한 참여를 보장하며, 작업 생태계의 장기적인 건강과 공정성을 유지하기 위함입니다.
...
## Oct 20, 2025
---
**프론티어 시스템 조정: 암호화 프론티어 중단**

<br />

<div style={{ marginTop: "1rem" }}></div>

암호화 프론티어가 공식적으로 중단되었습니다. 이 조치는 프론트엔드 진입점에만 영향을 미칩니다. 모든 역사적 기여 데이터는 그대로 유지되며 접근 가능합니다.

- **이유:** 이 결정은 자원을 집중하고 사용자 주의를 가장 우선 순위가 높은 활성 프론티어에 맞추기 위한 지속적인 제품 간소화의 일환입니다. 암호화 프론티어는 계획된 탐색 단계를 완료하였으며, 이를 중단함으로써 노력을 통합할 수 있습니다.
- **참고:** 암호화 프론티어에서의 사용자 과거 기여 및 보상은 보존되며, 기여 내역에서 검토할 수 있습니다. 다른 프론티어나 플랫폼 기능에는 영향을 미치지 않습니다.
...
높은 보상 메커니즘과 스팸 방지 시행을 통해 고품질의 구조화된 데이터를 체계적으로 수집하고, 유효성과 학문적 가치를 보장하며, 장기 기여자에게 보상하고 플랫폼의 데이터 생태계를 다각화하기 위해 다섯 개의 새로운 프론티어 모듈을 도입합니다.

- **조치:** 2.5M $XNY 상금 풀과 포인트 보상이 포함된 에어드랍 시즌 1을 시작했습니다.
- **새로운 프론티어:**
...
- **방법:** 선택된 프론티어 작업은 기본 포인트와 독립적으로 $XNY 또는 USDT로 추가 보상을 제공합니다. 활동 매개변수(보상 금액, 기간, 목표)는 각 프론티어별로 설정되며 해당 프론티어의 홈페이지에 표시됩니다.
...
- **접근:** 바이낸스 지갑 부스터 탭 또는 홈페이지 배너를 통해 접근 가능(Alpha Points ≥ 61 필요).
...
## Sep 12, 2025
---
**캠페인 시작: 코다타 부스터 캠페인 시즌 3 주 3**

<br />

<div style={{ marginTop: "1rem" }}></div>

AI 훈련 및 검증을 위해 생명, 로보틱스, 암호화, 모델 비교 및 지문 검증에 대한 교차 도메인 데이터를 수집합니다.
...
## Sep 05, 2025
---
**캠페인 시작: 코다타 부스터 캠페인 시즌 3 주 2**

<br />

<div style={{ marginTop: "1rem" }}></div>

AI 훈련 및 검증을 위해 생명, 로보틱스 및 암호화에 대한 교차 도메인 데이터를 수집하고 주석을 달기 위해 진행합니다.
...
## Aug 22, 2025
---
**캠페인 시작: 코다타 부스터 캠페인 시즌 3 주 1**

<br />

<div style={{ marginTop: "1rem" }}></div>

분산형 AI 훈련을 위한 생명, 로보틱스 및 암호화에 대한 교차 도메인 주석 데이터의 기초를 마련합니다.
...
- **Access:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **Rewards:** 총 보상 풀 50,000,000 $XNY (잠금 기간 포함), 작업 완료 및 검증 후 분배.
- **Timeline:** 2025년 8월 15일 07:00 UTC – 2025년 8월 22일 07:00 UTC.
...
프로젝트 학습, 음식 AI 판단, 로봇 주석, CEX 데이터 확장을 포함한 네 가지 주요 영역에서 주석이 달린 데이터를 체계적으로 수집하기 위함.

- **Access:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **Rewards:** 총 보상 풀 50,000,000 $XNY (잠금 기간 포함), 작업 완료 및 검증 후 분배.
- **Timeline:** 2025년 8월 8일 07:00 UTC – 2025년 8월 15일 07:00 UTC.
...
AI 음식 모델 비교, 로봇 상호작용 주석, CEX 핫 월렛 데이터 라벨링을 포함한 세 가지 핵심 도메인에서 주석이 달린 데이터를 수집하기 위함.

- **Access:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **Rewards:** 총 보상 풀 50,000,000 $XNY (잠금 기간 포함), 작업 완료 및 검증 후 분배.
- **Timeline:** 2025년 8월 1일 07:00 UTC – 2025년 8월 8일 07:00 UTC.
...
AI 음식 분석을 검증하고 주석이 달린 실제 상호작용 데이터를 통해 로봇 교육을 향상시키기 위함.

- **Access:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **Rewards:** 총 보상 풀 50,000,000 $XNY (잠금 기간 포함), 작업 완료 및 검증 후 분배.
- **Timeline:** 2025년 7월 24일 07:00 UTC – 2025년 7월 31일 07:00 UTC.
...
무게, 조리 방법, 칼로리 함량을 포함한 풍부한 주석을 수집하여 AI의 음식 이해를 심화시키기 위함.

- **Access:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **Rewards:** 총 보상 풀 50,000,000 $XNY, 작업 완료 및 검증 후 분배.
- **Timeline:** 2025년 7월 16일 13:00 UTC – 2025년 7월 23일 13:00 UTC.
...
문화적 및 맥락적 관련성을 넘어선 간편식의 주석이 달린 이미지를 수집하여 AI에게 인간의 식습관에 대한 미세한 이해를 가르치기 위함.

- **Access:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **Rewards:** 총 보상 풀 50,000,000 $XNY, 작업 완료 및 검증 후 분배.
- **Timeline:** 2025년 7월 9일 13:00 UTC – 2025년 7월 16일 13:00 UTC.
...
- **How:** 2025년 6월 30일에 일시적으로 오프라인 상태였으며, 현재 포괄적으로 복원됨.
- **Why:** 아키텍처 업그레이드를 통해 시스템 안정성과 사용자 경험을 향상시키기 위함.
...
채식, 비채식, 혼합 카테고리 전반에 걸쳐 미세한 이미지 라벨링을 통해 AI의 글로벌 음식 문화 및 선호도를 확장하기 위함.

- **Access:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **Rewards:** 총 보상 풀 50,000,000 $XNY, 작업 완료 및 검증 후 분배.
- **Timeline:** 2025년 7월 2일 13:00 UTC – 2025년 7월 9일 13:00 UTC.
...
주석이 달린 음식 데이터를 수집하고, 퀴즈를 통해 커뮤니티 지식을 활용하며, 다단계 인센티브 구조를 통해 참여를 보상하여 첫 시즌을 시작하기 위함.

- **Access:** Binance Wallet Booster 탭 또는 홈페이지 배너를 통해 접근 가능 (Alpha Points ≥ 61).
- **Rewards:** 총 보상 풀 50,000,000 $XNY, 작업 완료 및 검증 후 분배.
- **Timeline:** 2025년 6월 25일 13:00 UTC – 2025년 7월 2일 13:00 UTC.
